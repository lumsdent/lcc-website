  ...
  <div class="mx-auto max-w-md p-4">
    ...
    <form @submit.prevent="submitForm" class="flex flex-col gap-4">
      ...
      <div class="flex">
        ...
        <input type="text" id="summonerName" v-model="player.summonerName"
      ...
      <div class="flex">
        ...
        <input type="text" id="tag" v-model="player.tagLine"
          class="dark:text-logo-blue block w-full min-w-0 flex-1 rounded-none rounded-e-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" />
      </div>
      ...
      <div class="flex flex-col gap-2">
        <div v-for="role in roles" :key="`secondary-${role}`">
          <input type="radio" :id="`secondary-${role}`" name="secondaryRole" :value="role" v-model="player.secondaryRole"
            class="peer hidden" />
      ...
      <div>
        <label class="dark:text-logo-blue mb-2 block text-sm font-medium text-gray-900" for="reason">Tell us about yourself</label>
